...
public class CategoryFrame extends ModulesFrame {
    ...
    public static void catEarsRender(DrawContext context, float x, float y, float width) {
        ...
        context.drawTexture(RenderLayer::getGuiTextured, LEFT_EAR, (int) x - 7, (int) y - 8, 0, 0, 20, 20, 20, 20, 20, 20); //TODO: check
        context.drawTexture(RenderLayer::getGuiTextured, RIGHT_EAR, (int) (x + width) - 14, (int) y - 8, 0, 0, 20, 20, 20, 20, 20, 20);
