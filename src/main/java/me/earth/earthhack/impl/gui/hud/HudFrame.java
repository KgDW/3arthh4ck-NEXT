...
public class HudFrame extends Frame {
    ...
    public void drawScreen(DrawContext context, int mouseX, int mouseY, float partialTicks) {
        ...
        final float bodyTop = getPosY() + getHeight();
        final float bodyBottom = bodyTop + 1 + Math.min(getCurrentHeight(), scrollMaxHeight);
        ...
        if (isExtended()) {
            ...
            Render2DUtil.drawRect(context.getMatrices(), getPosX(), bodyTop, getPosX() + getWidth(), bodyBottom, 0x92000000);
