...
public class Interpolation implements Globals
{
    ...
    public static Box interpolateAxis(BlockPos pos, Box bb) {
        return interpolateAxis(new Vec3d(pos.getX(), pos.getY(), pos.getZ()), bb);
    }
    ...
    {
        bb.minX = bb.minX - mc.gameRenderer.getCamera().getPos().x;
        bb.minY = bb.minY - mc.gameRenderer.getCamera().getPos().y;
        bb.minZ = bb.minZ - mc.gameRenderer.getCamera().getPos().z;
        bb.maxX = bb.maxX - mc.gameRenderer.getCamera().getPos().x;
        bb.maxY = bb.maxY - mc.gameRenderer.getCamera().getPos().y;
        bb.maxZ = bb.maxZ - mc.gameRenderer.getCamera().getPos().z;
    }
