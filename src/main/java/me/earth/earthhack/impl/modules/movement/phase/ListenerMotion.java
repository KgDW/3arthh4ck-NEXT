        ...
        switch (module.mode.getValue())
        {
            ...
            case Skip:
                        ...
                        && mc.player.horizontalCollision)
                {
                    ...
                    {
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX(), mc.player.getY(), mc.player.getZ(), mc.player.onGround, false));
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX() + x * 0.001f, mc.player.getY() + 0.1f, mc.player.getZ() + z * 0.001f, mc.player.onGround, false));
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX() + x * 0.03f, 0, mc.player.getZ() + z * 0.03f, mc.player.onGround, false));
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX() + x * 0.06f, mc.player.getY(), mc.player.getZ() + z * 0.06f, mc.player.onGround, false));
                        event.setCancelled(true);
                        timer.reset();
                        return;
                    }
                    ...
                    {
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX(), mc.player.getY() + off[index], mc.player.getZ(), mc.player.onGround, false));
                        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(mc.player.getX() + (x * index), mc.player.getY(), mc.player.getZ() + (z * index), mc.player.onGround, false));
                    }
