        ...
        if (event.getStage() == Stage.PRE)
        {
            ...
            if (rotation != null) {
                ...
                if (module.rotateMode.getValue() == RotateMode.Smooth) {
                    ...
                    module.setRenderRotations(yaw, pitch);
                    event.setYaw(yaw);
                    event.setPitch(pitch);
                } else {
                    module.setRenderRotations(rotations[0], rotations[1]);
                ...
                if (bypassPos != null) {
                    ...
                    float yaw = (rotations[0] + module.rbYaw.getValue()) % 360;
                    module.setRenderRotations(yaw, pitch);
                    event.setYaw(yaw);
                    event.setPitch(pitch);
                }
