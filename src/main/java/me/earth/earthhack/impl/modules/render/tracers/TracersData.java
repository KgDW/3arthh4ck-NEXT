...
final class TracersData extends DefaultData<Tracers>
{
    public TracersData(Tracers module)
    {
        ...
        register(module.minRange, "Entities have to be at least this far away to get a tracer.");
        register(module.maxRange, "Entities need to be within this range to get a tracer.");
    }
