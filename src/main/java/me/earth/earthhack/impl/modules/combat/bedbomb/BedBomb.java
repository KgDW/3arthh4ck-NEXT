...
public class BedBomb extends Module
{
    ...
    public static void faceYawAndPitch(float yaw, float pitch) {
        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(yaw, pitch, mc.player.onGround, false));
    }
    ...
    public static void faceVector(Vec3d vec, boolean normalizeAngle) {
        ...
        mc.getNetworkHandler().sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(rotations[0], normalizeAngle ? ((int) rotations[1] % 360 + 360) % 360 : rotations[1], mc.player.onGround, false));
    }
    ...
    private static void sendSneakInput(boolean sneak) {
