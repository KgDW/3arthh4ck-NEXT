...
public class Step extends BlockESPModule
{
    ...
    protected void onDisable()
    {
        if (mc.player != null)
        {
            ...
            {
                mc.player.getAttributeInstance(EntityAttributes.STEP_HEIGHT).setBaseValue(1.0f);
            }

            mc.player.getAttributeInstance(EntityAttributes.STEP_HEIGHT).setBaseValue(0.6f);
        }
